...
import de.dc.fx.ui.renderer.model.provider.UIItemProviderAdapterFactory;
 ...
 * @generated
 */
public class UIEditor extends MultiPageEditorPart
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(UIModelWizard.FILE_EXTENSIONS, "*.");
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic = new BasicDiagnostic(Diagnostic.OK, "de.dc.fx.ui.renderer.model.editor", 0,
	...
	public Diagnostic analyzeResourceProblems(Resource resource, Exception exception) {
		...
		if (hasErrors || !resource.getWarnings().isEmpty()) {
			BasicDiagnostic basicDiagnostic = new BasicDiagnostic(hasErrors ? Diagnostic.ERROR : Diagnostic.WARNING,
					"de.dc.fx.ui.renderer.model.editor", 0,
					getString("_UI_CreateModelError_message", resource.getURI()),
					new Object[] { exception == null ? (Object) resource : exception });
			basicDiagnostic.merge(EcoreUtil.computeDiagnostic(resource, true));
			return basicDiagnostic;
		} else if (exception != null) {
			return new BasicDiagnostic(Diagnostic.ERROR, "de.dc.fx.ui.renderer.model.editor", 0,
	...
	public void doSaveAs() {
		...
		String[] files = UIEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return UIEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return UIEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
	}
