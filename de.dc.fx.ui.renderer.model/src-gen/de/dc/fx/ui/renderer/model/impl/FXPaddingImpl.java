...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>FX Padding</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dc.fx.ui.renderer.model.impl.FXPaddingImpl#getTop <em>Top</em>}</li>
 *   <li>{@link de.dc.fx.ui.renderer.model.impl.FXPaddingImpl#getBottom <em>Bottom</em>}</li>
 *   <li>{@link de.dc.fx.ui.renderer.model.impl.FXPaddingImpl#getRight <em>Right</em>}</li>
 *   <li>{@link de.dc.fx.ui.renderer.model.impl.FXPaddingImpl#getLeft <em>Left</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FXPaddingImpl extends MinimalEObjectImpl.Container implements FXPadding {
	/**
	...
	protected EClass eStaticClass() {
		return UIPackage.Literals.FX_PADDING;
	}
	...
	public void setTop(double newTop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UIPackage.FX_PADDING__TOP, oldTop, top));
	}
	...
	public void setBottom(double newBottom) {
		...
		bottom = newBottom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UIPackage.FX_PADDING__BOTTOM, oldBottom, bottom));
	}
	...
	public void setRight(double newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UIPackage.FX_PADDING__RIGHT, oldRight, right));
	}
	...
	public void setLeft(double newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UIPackage.FX_PADDING__LEFT, oldLeft, left));
	}
